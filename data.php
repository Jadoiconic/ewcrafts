                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped">
                                ...
                                <?php
                                $slt = "SELECT * FROM `products` WHERE `userId`='$userId'";
                                $n = 1;
                                ...
                                while ($row = mysqli_fetch_array($qry)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php print($row['decription']) ?>
                                        </td>
                                        <td>
                                            <?php print($row['quantity']) ?>
                                        </td>
                                        <td>
                                            <?php print($row['impact']) ?>
                                        </td>
                                        <td>
                                            <?php print($row['category']) ?>
                                        </td>
                                        <td>
                                            <?php print($row['images']) ?>
                                        </td>
                                        <td>
                                            <?php print($row['createdAt']) ?>
                                        </td>
                                        <td><a class="btn py-0 btn-success"
                                                href="updateProductItem.php?q=<?php print($row[0]) ?>">Update</a></td>
